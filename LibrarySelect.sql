...
-- Q. Retrieve details of all book in the library - id, title, name of publisher, authors, number of copies in each brancch etc.
...
-- Q. Get the particular of borrowers who have borrowed more than 2 books, but from certrain date
